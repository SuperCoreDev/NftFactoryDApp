...
interface SimpleNFTInterface extends ethers.utils.Interface {
  functions: {
    ...
    "mintNFTWithToken()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "mintNFTWithToken",
    values?: undefined
  ): string;
  ...
  events: {
    ...
    "Transferred(address,address)": EventFragment;
  };
...
export class SimpleNFT extends BaseContract {
  ...
  callStatic: {
    ...
    mintNFTWithToken(overrides?: CallOverrides): Promise<void>;
